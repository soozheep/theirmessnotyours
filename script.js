const SITE_URL = 'https://theirmessnotyours.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Their Mess Not Yours — Sonic Remedy | Soozhee',
        text: 'Their mess is theirs; your light shines through. Their Mess Not Yours by Soozhee.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
